...
from account.views import LogoutView, DeleteView, SignupView, LoginView, \
    ConfirmEmailView, ChangePasswordView, PasswordResetView, \
    PasswordResetTokenView, SettingsView

urlpatterns = [
    url(r"^signup/$", SignupView.as_view(), name="account_signup"),
    url(r"^login/$", LoginView.as_view(), name="account_login"),
    url(r"^logout/$", LogoutView.as_view(), name="account_logout"),
    url(r"^confirm_email/(?P<key>\w+)/$", ConfirmEmailView.as_view(),
